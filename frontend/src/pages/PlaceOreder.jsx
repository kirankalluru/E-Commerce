  ...
  return (
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
          ...
          <input className='border border-gray-300 py-1.5 px-3.5 w-full' placeholder='Street' type="text" />
          ...
          <div className='flex gap-3 '>
            <input className='border border-gray-300 py-1.5 px-3.5 w-full' placeholder='ZipCode' type="number" />
            <input className='border border-gray-300 py-1.5 px-3.5 w-full' placeholder='Country' type="text" />
          </div>
          <input className='border border-gray-300 py-1.5 px-3.5 w-full' placeholder='Phone' type="number" />
        ...
        <div className='mt-12'>
          ...
          <div className='flex gap-3 flex-col lg:flex-row'>
                ...
                <div onClick={()=>setMethod('razorpay')}  className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
                  ...
                  <img className='h-5 mx-4' src={assets.razorpay_logo} alt="slogo" />
                </div>
          ...
          <div className='w-full text-end'>
            <button onClick={()=>navigate('/Order')} className="bg-black text-white font-semibold my-8 py-3 px-8 rounded-lg shadow-md active:bg-gray-800 cursor-pointer">PLACE ORDER</button>
          </div>
        </div>
